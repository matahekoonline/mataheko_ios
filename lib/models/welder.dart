/// A self-registered or admin-added welding service provider.
/// Firestore collection: `welders`, doc id == the provider's uid (for
/// self-registered) or an auto id (for admin-added).
///
/// Mirrors Tiler/Carpenter/SteelBender exactly, field-name style included,
/// so ManageProvidersScreen / AdminProviderRecord keep working unchanged
...
class Welder {
  ...
  factory Welder.fromMap(String id, Map<String, dynamic> map) {
    return Welder(
      id: id,
