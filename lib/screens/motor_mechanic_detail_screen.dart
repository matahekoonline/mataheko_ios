...
class MotorMechanicDetailScreen extends StatefulWidget {
  final MotorMechanic mechanic;
  const MotorMechanicDetailScreen({super.key, required this.mechanic});

  @override
  State<MotorMechanicDetailScreen> createState() => _MotorMechanicDetailScreenState();
}

class _MotorMechanicDetailScreenState extends State<MotorMechanicDetailScreen> {
  late double _rating;
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                      onPressed: submitting
                        ...
                        try {
                          await AuthService.instance.submitMotorMechanicReview(
          ...
          children: [
            Row(
              children: [
                CircleAvatar(
                  ...
                  backgroundImage: (mechanic.photoUrl != null && mechanic.photoUrl!.isNotEmpty)
                      ? NetworkImage(mechanic.photoUrl!)
                      : null,
                  child: (mechanic.photoUrl == null || mechanic.photoUrl!.isEmpty)
                      ? Icon(Icons.build, color: Colors.green[800], size: 32)
                      : null,
                ),
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      Text(
                        mechanic.workshopName.isNotEmpty ? mechanic.workshopName : mechanic.name,
            ...
            Row(
              children: [
                ...
                const SizedBox(width: 4),
                Text(mechanic.stationArea, style: TextStyle(fontSize: 12, color: Colors.grey[600])),
              ],
            ),
            ...
            _SectionCard(
              ...
              child: Row(
                children: [
                  ...
                  Text(
                    '${mechanic.yearsOfExperience} years in the trade',
                    style: const TextStyle(fontWeight: FontWeight.w600),
                  ),
                  const Spacer(),
                  if (mechanic.offersRoadsideService)
                    Container(
                      ...
                      child: Row(
                        children: [
                          Icon(Icons.car_repair, size: 14, color: Colors.blue[800]),
                          const SizedBox(width: 4),
                          Text('Roadside Service', style: TextStyle(fontSize: 11, color: Colors.blue[800], fontWeight: FontWeight.w600)),
                        ],
                      ),
                    ),
                ],
              ...
              children: [
                Expanded(
                  child: ElevatedButton.icon(
                    onPressed: () => _callNumber(mechanic.phoneNumber),
                ...
                Expanded(
                  child: OutlinedButton.icon(
                    onPressed: () => _whatsApp(mechanic.phoneNumber),
            ...
            StreamBuilder<QuerySnapshot<Map<String, dynamic>>>(
              stream: AuthService.instance.motorMechanicReviewsStream(mechanic.id),
