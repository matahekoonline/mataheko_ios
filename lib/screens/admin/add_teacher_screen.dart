...
class _AddTeacherScreenState extends State<AddTeacherScreen> {
  ...
  Future<void> _pickImage(bool isTeacherPhoto) async {
  ...
  Future<void> _submit() async {
    ...
    if (_selectedClassLevels.isEmpty) {
      setState(() => _error = 'Select at least one class level.');
      return;
    }
    if (_teacherPhoto == null) {
    ...
    try {
      ...
      final teacher = Teacher(
        ...
        schoolOrInstitution: _schoolController.text.trim(),
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text('Teacher added')));
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                Center(
                  child: GestureDetector(
                    ...
                    child: CircleAvatar(
                      ...
                      backgroundImage: _teacherPhoto != null ? FileImage(_teacherPhoto!) : null,
                      child: _teacherPhoto == null
                ...
                const Center(
                  child: Text('Photo (shown to app users)', style: TextStyle(fontSize: 12, color: Colors.grey)),
                ),
                ...
                DropdownButtonFormField<String>(
                  ...
                  validator: (v) => v == null ? 'Please select a qualification' : null,
                ),

                const SizedBox(height: 20),
                _chipSection('Class Levels Taught', classLevelOptions, _selectedClassLevels),
                const SizedBox(height: 20),
                _chipSection('Subjects Taught', subjectOptions, _selectedSubjects),
